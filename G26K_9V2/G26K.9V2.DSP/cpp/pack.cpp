...
void Pack_2_uLaw(RSPWAVE *dsc)
{
	...
	rsp.hdr.packType = PACK_ULAW12;
	rsp.hdr.packLen = (rsp.hdr.sl+1)/2;

	WavePack_uLaw_12Bit((i16*)rsp.data, (byte*)rsp.data, rsp.hdr.packLen*2);
...
void Pack_3_ADPCMIMA(RSPWAVE *dsc)
{
	...
	rsp.hdr.packType = PACK_ADPCMIMA;
	rsp.hdr.packLen = (rsp.hdr.sl+3)/4;

	WavePack_ADPCMIMA((i16*)rsp.data, (byte*)rsp.data, rsp.hdr.packLen*4);
